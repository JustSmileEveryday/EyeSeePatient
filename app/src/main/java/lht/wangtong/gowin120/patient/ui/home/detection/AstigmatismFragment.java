 ...
 * @author luoyc
 */
public class AstigmatismFragment extends BaseFragment<AstigmatismPresenter> implements AstigmatismContract.View {
    @BindView(R.id.step_view)
    HorizontalStepView mHorizontalStepView;
    @BindView(R.id.eye_img)
    ImageView mAstigmatismImg;
    private List<StepBean> stepBeans;
    private String mFamilyId = "";
    private int mPositon = 0;

    public static AstigmatismFragment newInstance() {
        return new AstigmatismFragment();
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_astigmatism;
    }
    ...
    public void setStepView(int positon) {
        mPositon = positon;
        mAstigmatismImg.setBackground(getActivity().getResources().getDrawable(stepBeans.get(positon).getDrawableId()));
    }
