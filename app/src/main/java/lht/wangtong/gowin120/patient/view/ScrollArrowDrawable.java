...
public class ScrollArrowDrawable extends Drawable {
    ...
    public ScrollArrowDrawable(RecyclerView rv, int backgroundColor) {
        this.rv = rv;
    ...
    public void draw(@NonNull Canvas canvas) {
        if (rv != null && rv.getLayoutManager() != null) {
            ...
            arrowPath.lineTo(arrowCenter.x, bounds.bottom);
            arrowPath.lineTo(arrowCenter.x - arrowLen / 2, bounds.bottom - arrowHeight);
            ...
            canvas.drawRect(bounds.left, bounds.top, bounds.right, bounds.bottom - arrowHeight, contentPaint);
        }
    }
