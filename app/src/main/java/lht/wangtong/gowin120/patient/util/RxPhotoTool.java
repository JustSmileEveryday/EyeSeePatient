...
import static lht.wangtong.gowin120.patient.util.RxFileTool.getDataColumn;
import static lht.wangtong.gowin120.patient.util.RxFileTool.isDownloadsDocument;
import static lht.wangtong.gowin120.patient.util.RxFileTool.isExternalStorageDocument;
import static lht.wangtong.gowin120.patient.util.RxFileTool.isGooglePhotosUri;
import static lht.wangtong.gowin120.patient.util.RxFileTool.isMediaDocument;
...
public class RxPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ToastUtils.showShort("请先获取写入SDCard权限");
        } else {
